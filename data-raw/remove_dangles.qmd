...
edin_offroad_net = edinburgh_offroad |> filter(component  == 7)
```
...
edges = st_cast(edin_offroad_net, "LINESTRING")
...
mapview(node_degree_sf, zcol = "degree") + mapview(edin_offroad_net)
```
