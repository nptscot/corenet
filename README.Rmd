...
sf::st_crs(NPT_demo_3km) = 27700
sf::st_crs(os_edinburgh_demo_3km) = 27700
```

```{r}
# Prepare the network for analysis
OS_NPT_demo = cohesive_network_prep(base_network = os_edinburgh_demo_3km, 
                                     influence_network = NPT_demo_3km, 
                                     target_zone, 
                                     crs = "EPSG:27700", 
...
CN_network = corenet(NPT_demo_3km, OS_NPT_demo, target_zone, 
                      key_attribute = "all_fastest_bicycle_go_dutch", 
