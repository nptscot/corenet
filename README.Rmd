...
```{r}
zones = zonebuilder::zb_zone("Edinburgh", n_circles = 1) |> sf::st_transform(crs = "EPSG:27700")
...
# sf::st_write(mini_NPT, "data/Minimal_NPT.geojson", driver = "GeoJSON")
